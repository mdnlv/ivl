const Politic = () => {
  return <div id="inputResult">
    
  <div class="row mb-4">
      <div class="col">
          <h4><strong>Политика конфединциальности</strong></h4>
      </div>
  </div>
          ...
          <div class="ol">
              <div class="li">7.1. Цель обработки персональных данных Пользователя:</div>
                  <div id="generatedProcessingTargets">
                      ...
                      <div class="li">– <mark>предоставление доступа Пользователю к сервисам, информации и/или материалам, содержащимся на веб-сайте httpsː//thismywebsite·com;</mark></div>
                      <div class="li">– <mark>уточнение деталей заказа.</mark></div>
                  </div>
